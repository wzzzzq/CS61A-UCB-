...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        place=self.place
        dis=0
        while place!=None and place.is_hive==False:
            tmp=random_bee(place.bees)
            if self.min_range<=dis<=self.max_range and tmp!=None:
                return tmp
...
class ContainerAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 8
        "*** YOUR CODE HERE ***"
        return (self.is_container and self.ant_contained==None and (not other.is_container))
        # END Problem 8
